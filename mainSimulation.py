...
def mainSimulation(enablePlots=False,SystemParams=SystemParams,ControllerParams=ControllerParams,SimulationParams=SimulationParams):
    #Pre-allocate
    ...
    if enablePlots == True:
        ...
        return [posTrue,velTrue,TotalEnergy,ForceHistory]
